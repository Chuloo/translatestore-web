      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide text-primaryText px-8 sm:px-8 md:px-20 lg:px-4">
            ...
            <h1 className="hidden md:inline">Translate your store in</h1>
          </div>
        ...
        >
          <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-24">
            Sell to anyone in any language using our AI-powered translation
            tool. Embed a translation widget with 100+ languages on your
            ecommerce store.
          </h2>
        </motion.div>
        <motion.div
